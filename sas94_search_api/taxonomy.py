...
FAMILY_RULES: dict[str, dict[str, tuple[str, ...]]] = {
    ...
    "missing_values": {
        ...
        "docsets": ("lepg",),
        "sections": ("missing values", "special missing values", "missing data"),
    },
    "macro_definition": {
        "markers": (
            "%let",
    ...
    "formats": {
        ...
        "docsets": ("proc", "lepg"),
        "sections": ("format procedure", "syntax: format procedure", "usage: format procedure", "format statement", "formats", "informats"),
    },
    "ods": {
